...
//             <p className='text-white '> { invoices.length === 0 ? 'No Pending Bill' : `Total bill is ${invoices.length}` } </p>
//         </div>
...
//                       {({ active }) => (
//                         <button
//                             className={`${active ? 'bg-slate-600' : ''} w-full text-left text-white px-4 py-2 rounded-lg capitalize 
//                             ${filter === S ? 'text-white' : 'text-gray-900'} cursor-pointer`} onClick={() => dispatch(setFilter(S))} >
//                             {S}
//                         </button>
//                       )}
//                    </MenuItem>
...
//             <button type='submit' className='bg-red-400 text-white hover:bg-red-600 text-white px-6 py-2 rounded-full flex items-center space-x-2 cursor-pointer' onClick={onNewInvoice}>
